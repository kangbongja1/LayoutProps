  ...
  return (
    <>
      ...
      <Text> 테스트입니다. dar dar dar</Text>
        ...
        <Text>손흥민은 지난 맨유 원정 2골 1도움을 몰아치며 올 시즌 리그 4경기 6골 1도움을 기록 중이다. 한국인 최초 빅리그 100골 고지도 넘기며 살아있는 전설이 되고 있다. 또한 이번 시즌 좋은 출발을 보이고 있는 도미닉 칼버튼 르윈(6골)과 득점 공동 선두에 올랐다.</Text>
        <Image 
          style={{
            width: 300,
            height: 300,
